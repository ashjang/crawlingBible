...
def main():
    ...
    first_site = "http://www.holybible.or.kr/B_NIV/"
    ...
    for i in range(len(address)):
        ...
        # driver.get("http://www.holybible.or.kr/B_NIV/cgi/bibleftxt.php?VR=3&CI={}&CV=99".format(address_urlNum[i]))
        # time.sleep(1)
        # print("\n\n\n" + address[i])
        ...
        for chapter in range(address_chapterNum[i]):
            url = "http://www.holybible.or.kr/B_NIV/cgi/bibleftxt.php?VR=3&CI={}&CV=99"
